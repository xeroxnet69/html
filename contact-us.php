...
</script>		<link rel="shortcut icon" href="images/16.ico" type="image/x-icon" />
		...
		<!----- start-header---->
			...
			<div id="work" class="work" style="background-color:white;">													
							...
							<div class="head-one text-center">
								...
								<!--<h3><a href="/Social/groups/contact-teerBodoland-com/"><u>Click Here to Chat with Us</u></a></h3>
								-->
								<span> </span>
							</div>
							<div align="center" class="contact-grids">
								...
								<form  id ="panel" action="http://teerbodoland.com/contact-submit.php" method="POST" onsubmit="return validateForm()">
